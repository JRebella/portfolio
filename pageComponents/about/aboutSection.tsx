  ...
  return (
    <section className={styles.container}>
      ...
      <div>
        ...
        {/* <p>
          If you're looking for a "robot" developer, I'm not your guy, I like to go deep
          into the business and understand it. If a requirement doesn't feel right to me
          or I think there's a better way of solving a problem, I'll speak up and do my
          best to sprout a productive discussion.
        </p> */}
      </div>
    </section>
  );
